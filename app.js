(function () {
  ...
  function renderAgentDrawer() {
    ...
    const income = `<section class="form-section"><div class="form-section-title"><strong>经营指标</strong><span>本月 · 数据更新于10:20</span></div><div class="reference-detail"><div><span>店铺客户（推广人数）</span><strong>${agent.customers}人</strong></div><div><span>团队有效订单</span><strong>${agent.orders}笔</strong></div><div><span>已结算店铺收益</span><strong>${agent.commission}</strong></div><div><span>待结算业务收益</span><strong>¥540.00</strong></div></div></section><section class="form-section commission-card"><div class="form-section-title"><strong>当前店铺收益方案</strong><span>订单快照为准</span></div><div class="reference-detail"><div><span>方案版本</span><strong>方案1.2</strong></div><div><span>主要品类</span><strong>鞋服 6% · 手机 3%</strong></div></div></section>`;
